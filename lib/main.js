...
function default_1(context) {
    ...
    LocalMain.addIpcAsyncListener('supercharged:get-debug-constants', (siteId) => __awaiter(this, void 0, void 0, function* () {
        ...
        const cached = (_a = site.superchargedAddon) === null || _a === void 0 ? void 0 : _a.debugConstants;
        if (cached) {
    ...
    LocalMain.addIpcAsyncListener('supercharged:set-debug-constant', (siteId, constant, value) => __awaiter(this, void 0, void 0, function* () {
        ...
        const cached = (_b = site.superchargedAddon) === null || _b === void 0 ? void 0 : _b.debugConstants;
        const updatedCache = Object.assign(Object.assign({}, cached), { [constant]: value });
