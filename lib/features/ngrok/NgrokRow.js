...
const local_components_3 = require("@getflywheel/local-components");
...
function createNgrokRow(React) {
    ...
    const NgrokRow = ({ site }) => {
        ...
        const handleToggle = useCallback((_name, checked) => __awaiter(this, void 0, void 0, function* () {
            if (!savedUrl.trim()) {
                return;
            }
            ...
            setUpdating(true);
            try {
                yield LocalRenderer.ipcAsync(types_1.IPC_CHANNELS.ENABLE_NGROK, site.id, checked, savedUrl.trim());
            }
            catch (e) {
        ...
        const handleStartStop = useCallback(() => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                setError((e === null || e === void 0 ? void 0 : e.message) || 'Failed to start ngrok process');
            }
            finally {
                setUpdating(false);
            }
        ...
        return (React.createElement(local_components_1.TableListRow, { label: "ngrok", alignMiddle: true },
            React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: '10px' } },
                React.createElement(local_components_2.Switch, { tiny: true, flat: true, disabled: updating || !savedUrl.trim(), checked: enabled, onChange: handleToggle, name: "ngrok-toggle" }),
                ...
                React.createElement(local_components_3.TextButtonExternal, { onClick: handleApply, disabled: updating || enabled || !url.trim() || !urlDirty }, "Save"),
                React.createElement(local_components_3.TextButtonExternal, { onClick: handleClear, disabled: updating || (!url && !savedUrl) }, "Clear"),
                React.createElement(local_components_3.TextButtonExternal, { onClick: handleStartStop, disabled: updating || !enabled || !savedUrl }, processStatus === 'running' ? 'Stop' : 'Start'),
                enabled && savedUrl && (React.createElement("span", { style: {
                        display: 'inline-flex',
                        alignItems: 'center',
                        gap: '4px',
                        fontSize: '12px',
